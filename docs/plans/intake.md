...
| --- | --- |
| Egocentric shop-floor process intelligence | 是否建立第一视角与固定机位协同的车间过程智能能力，用于质量事件视频追溯、技能与 SOP 提取、新员工防错及经人工复核的效率分析；在选择首个试点工序时继续讨论采集设备、MES/质量关联、数据最小化与保留、边缘推理、模型评估和员工权益边界。首次记录：2026-09-24 14:24:21 CST。 |
